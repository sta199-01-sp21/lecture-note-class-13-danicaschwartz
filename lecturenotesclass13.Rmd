...
The downside of using point estimates is that any point estimate is not absolutely accurate. It is an estimate based on only a single random sample. If repeated random samples were taken from the population, the point estimate would be expected to vary from sample to sample.
...
I would expect around 5 of them to be left handed, and therefore would not be very surprised if only 3 of them were left-handed.
...
- Population: one-bedroom apartments in Manhatten
...
This means that with repeated draws, we can be 95% confident that the true mean price of one-bedroom apartments in Manhatten lies within the interval 2299-2977.  
...
This means that with repeated draws, we can be 95% confident that the true median price of one-bedroom apartments in Manhatten lies within the interval 2162-2875.  
...
- Population: mice that died while not in treatment 
- Parameter of interest: proportion 
- Sample: mice that died while not in treatment 
- Sample size: 261
...
This means that with repeated draws, we can be 95% confident that the true proportion of mice that died while not in treatment lies within the interval 0.690-0.793.  
...
This means that with repeated draws, we can be 90% confident that the true proportion of mice that lived while on the treatment, regardless of the dose lies within the interval 0.552-0.6513. 
